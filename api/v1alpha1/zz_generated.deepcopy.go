...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StsVersions) DeepCopyInto(out *StsVersions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StsVersions.
func (in *StsVersions) DeepCopy() *StsVersions {
	if in == nil {
		return nil
	}
	out := new(StsVersions)
